...
{{% blocks/products/pf/agp/code-block title="채워진 NEET 양식을 인식하는 C# 코드" offSpacer="true" %}}
...
<p><a href="/omr/exam/neet/neet.zip"><b>neet.omr</b></a> 파일에는 Aspose.OMR 인식 엔진으로 매우 정확한 결과를 생성하는 데 사용되는 인식 패턴이 포함되어 있습니다. 인쇄 가능한 NEET 템플릿과 함께 생성됩니다. 해당 파일을 삭제하거나 바꾸지 마십시오. </p>
...
{{% blocks/products/pf/feature-page-section  h2="이익" %}}
