...
Да бисте га додали свом пројекту, потребно је само да инсталирате *Аспосе.ОЦР* [НуГет](хттпс://ввв.нугет.орг/пацкагес/аспосе.оцр) пакет у свој пројекат помоћу следеће команде:
...
<ul>
	...
	<li>Круг мехурића треба да буде потпуно попуњен оловком или црним маркером.</li>
 ...
 <a class="anchor" id="features" name="features"> </a>
  <div class="container">
   ...
   <div class="col">
        ...
        <p class="col-lg-10">
        Прочитајте попуњен НЕЕТ образац и сачувајте резултате у ЈСОН, КСМЛ или ЦСВ форматима. Могу се програмски анализирати, оцењивати и увозити у било коју релациону или НоСКЛ базу података.
        </p>
   </div>
   </div>
  </div>
