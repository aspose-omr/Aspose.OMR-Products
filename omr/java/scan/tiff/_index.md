---
title: Scan TIFF Images using Java
description: Java code to scan TIFF images for cases like Answer Sheet Images or MCQ Answer Sheets 
url: /java/scan/tiff/
family: omr
platformtag: java
feature: scan
...
{{< blocks/products/pf/feature-page-header h1="Scan TIFF Images via Java" h2="Perform OMR operation on TIFF images to recognize or extract data for cases such as MCQ answer sheets and surveys." >}}
...
3. Define the TIFF image path and use [RecognizeImage method](https://apireference.aspose.com/java/omr/com.aspose.omr/TemplateProcessor#recognizeImage-java.lang.String-) to get the result.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to scan TIFF images via Java" offSpacer="" %}}

{{< gist "aspose-com-gists" "00046127a0febf841d2b0a0df6e2b701" "scan-tiff-images-for-omr-operation.java" >}}
