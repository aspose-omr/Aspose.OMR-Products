---
title: Scan JPEG Images using Java
description: Java code to scan JPEG images for cases like Answer Sheet Images or MCQ Answer Sheets 
url: /java/scan/jpeg/
family: omr
platformtag: java
feature: scan
informat: JPEG
outformat:
otherformats: TIFF BMP GIF PNG
---
{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="Scan JPEG Images via Java" h2="Perform OMR operation on JPEG images to recognize or extract data for cases such as MCQ answer sheets and surveys." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Scan JPEG Images" %}}
...
3. Define the JPEG image path and use [RecognizeImage method](https://apireference.aspose.com/java/omr/com.aspose.omr/TemplateProcessor#recognizeImage-java.lang.String-) to get the result.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to scan JPEG images via Java" offSpacer="" %}}

{{< gist "aspose-com-gists" "00046127a0febf841d2b0a0df6e2b701" "scan-jpg-images-for-omr-operation.java" >}}
