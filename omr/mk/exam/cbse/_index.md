...
<p><b>Откако ќе завршите, извршете го следниов код за да [генерирате](https://docs.aspose.com/omr/net/generate-template/) шаблон за печатење за формуларот CBSE:</b></p>
