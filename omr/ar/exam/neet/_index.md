...
<p>اختبار القبول الوطني (NEET) هو امتحان القبول الموحد للقبول في MBBS و BDS و BAMS و BSMS و BUMS و BHMS والدورات الطبية الأخرى في الكليات والجامعات والمعاهد في الهند. تعتبر نتيجة الاختبار الناجحة أمرًا ضروريًا لطلاب الدراسات العليا والجامعيين الذين يتابعون التعليم الطبي الأساسي في الخارج. NEET عبارة عن اختبار بالقلم والورق يتكون من 180 سؤالًا ، مما يجعل من المستحيل تقريبًا التحقق من النتائج وتقييمها يدويًا. تصبح القراءة الآلية للنموذج (OMR) عنصرًا حاسمًا في التقييم.</p>
...
لإضافته إلى مشروعك ، تحتاج فقط إلى تثبيت حزمة * Aspose.OCR * [NuGet] (https://www.nuget.org/packages/aspose.ocr) في مشروعك باستخدام الأمر التالي:
...
<p><a href="https://www.aspose.cloud/templates/aspose/img/products/omr/neet.omr"><b>net.omr</b></a> يحتوي الملف على نمط التعرف الذي يتم استخدامه لإنتاج نتائج دقيقة للغاية باستخدام محرك التعرف Aspose.OMR. يتم إنشاؤه جنبًا إلى جنب مع نموذج NEET القابل للطباعة ؛ تأكد من عدم حذف أو استبدال هذا الملف. </p>
 ...
 <a class="anchor" id="features" name="features"> </a>
  <div class="container">
   ...
   <div class="col">
        ...
        <p class="col-lg-10">
        قم بمعالجة العشرات من نماذج NEET المكتملة في الدقيقة
        </p>
   </div>
   </div>
   <div class="row">
   ...
   <div class="col">
        ...
        <p class="col-lg-10">
        تتيح لك لغة الترميز المرنة تصميم نماذج OMR قابلة للقراءة آليًا من أي تخطيط أو تعقيد. ورقة NEET هي مجرد واحدة من حالات الاستخدام.
        </p>
   </div>
   <div class="col">
