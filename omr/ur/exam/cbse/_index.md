...
<p><b>ایک بار مکمل ہونے کے بعد، CBSE فارم کے لیے پرنٹ ایبل ٹیمپلیٹ [generate](https://docs.aspose.com/omr/net/generate-template/) کے لیے درج ذیل کوڈ کو چلائیں:</b></p>
