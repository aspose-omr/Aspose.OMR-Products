---
title: Scan BMP Images using C#
description: C# code to Scan BMP images for cases like Answer Sheet Images or MCQ Answer Sheets 
url: /net/scan/bmp/
family: omr
platformtag: net
feature: scan
...
{{< blocks/products/pf/feature-page-header h1="Scan BMP Images via C#" h2="Perform OMR operation by scanning BMP images to recognize or extract data for cases such as MCQ answer sheets and surveys." >}}
...
3. Define the BMP image path and use [RecognizeImage method](https://apireference.aspose.com/omr/net/aspose.omr.api/templateprocessor/methods/recognizeimage) to get the result.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows how to scan BMP images via C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "1e7ebb667a6dca37fc30292c0b41da72" "scan-bmp-image-for-omr-operation.cs" >}}
