...
<p><b>Tamamlandığında, CBSE formu için yazdırılabilir bir şablon [oluşturmak](https://docs.aspose.com/omr/net/generate-template/) için aşağıdaki kodu çalıştırın:</b></p>
