...
weight: 40
url: /zh-hant/java/ 
description: Java OMR 閱讀器和處理庫，可高精度識別掃描圖像甚至照片。 API 在基於 OMR 的軟件中對圖像和照片執行操作
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java OMR 識別和解析器 API" h2="從掃描圖像和照片中識別各種格式的 OMR 數字化紙張圖像中的光學標記。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/omr/headers/aspose_omr-for-java.svg" pfName="Aspose.OMR" subTitlepfName="for Java" downloadUrl="https://downloads.aspose.com/omr/java" >}}
...
<p>
 Aspose.OMR for Java 是一個用於從各種圖像（包括 PNG、GIF、JPEG、TIFF、BMP）中識別光學標記的 API。 API 以 CSV 和 JSON 格式保存結果，並且可以在執行 OMR 操作時以文本格式顯示結果。此外，OMR 識別 API 從調查、MCQ 論文、問卷等多個來源的文件中捕獲人工標記數據。在識別所有這些來源的掃描圖像甚至圖片期間，保持高精度。
</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="Aspose.OMR for Java API 概述。" >}}
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="Java OMR 處理 API" src="https://www.aspose.cloud/templates/aspose/img/products/omr/aspose_omr-for-java.svg"/>
  <header>
   Aspose.OMR
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="平台獨立性" description="Aspose.OMR for Java 支持 Java 運行時。" >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="OMR 操作 API" src="https://www.aspose.cloud/templates/aspose/img/products/omr/aspose_omr-for-java.svg"/>
  <header>
   Aspose.OMR
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="Aspose.OMR for Java 支持流行的 [圖像文件格式](https://docs.aspose.com/omr/java/supported-file-formats/)  下面列出。" >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Advanced Java OMR 處理 API Features
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
...
{{< blocks/products/pf/slr-tab tabTitle="為什麼選擇 Aspose.OMR for Java？" tabId="success-stories" >}}
